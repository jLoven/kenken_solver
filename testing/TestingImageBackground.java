...
public class TestingImageBackground {
	...
	public static void addNewLabelToFrame(JFrame frame, BufferedImage image, int x, int y, int sizeX, int sizeY) {
	...
	public static void main(String arg[]) throws IOException {
    	...
    	addNewLabelToFrame(frame, image, 50, 50, 50, 50);
